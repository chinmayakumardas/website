...
//     onClick={submit}
//     disabled={loading}
//     className="relative flex items-center text-sm font-medium rounded-full h-12 p-1 ps-8 pe-14 group transition-all duration-500 hover:ps-14 hover:pe-8 w-fit overflow-hidden cursor-pointer bg-primary text-secondary disabled:opacity-50"
//   >
